...
const Login = () => {
    ...
    const { loginUser, isLoading,  user, setUser, errorMsg  } = useAuth();
            ...
            <Grid container rowSpacing={1} columnSpacing={{ xs: 1, sm: 2, md: 3 }} sx={{ p: 5 }}>
                <Grid sx={{ width: '75%', display: 'flex', marginTop: '30px', alignItems: '', justifyContent: 'center', }} item xs={12} sm={12} md={6}>
                    ...
                    <form onSubmit={handleLoginSubmit}>
                        ...
                        {/*PASSWORD */}
                        {/* ------------------------ */}
                        <TextField type="password" required onChange={handleOnChange} sx={{ width: 1 }} id="outlined-basic" label="Password" variant="outlined" name='password' />
